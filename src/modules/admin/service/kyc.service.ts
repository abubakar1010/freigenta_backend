...
export class AdminKycService {
  ...
  async getKycDetails(id: string) {
    ...
    if (u.identityVerificationStatus === "VERIFIED") status = "Approved";
    else if (u.identityVerificationStatus === "REJECTED") status = "Rejected";
    else if (u.identityVerificationStatus === "PENDING" || u.identityVerificationStatus === "MANUAL_REVIEW") status = "Under Review";
    else status = "Need info";
